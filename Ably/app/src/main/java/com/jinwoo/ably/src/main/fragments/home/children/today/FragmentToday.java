...
public class FragmentToday extends Fragment {
    ...
    private ArrayList<SlideImage> banners;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        banners.add(new SlideImage(R.drawable.img_banner_01));
        banners.add(new SlideImage(R.drawable.img_banner_02));
        banners.add(new SlideImage(R.drawable.img_banner_03));
        banners.add(new SlideImage(R.drawable.img_banner_04));
        banners.add(new SlideImage(R.drawable.img_banner_05));
        banners.add(new SlideImage(R.drawable.img_banner_06));
        banners.add(new SlideImage(R.drawable.img_banner_07));
        banners.add(new SlideImage(R.drawable.img_banner_08));
        banners.add(new SlideImage(R.drawable.img_banner_09));
        banners.add(new SlideImage(R.drawable.img_banner_10));
        ...
        productList.add(new Product(R.raw.gif_product_1, photos, 10, 22800, "이너니티", "주문폭주/당일출고:-) 데일리 밑단컷팅 청스커트", "NEW" ,"1,464개 구매중"));
        productList.add(new Product(R.raw.gif_product_1, photos, 0, 22800, "이너니티", "주문폭주/당일출고:-) 데일리 밑단컷팅 청스커트", "HOT_DEAL", "1,464개 구매중"));
        productList.add(new Product(R.raw.gif_product_1, photos, 10, 22800, "이너니티", "주문폭주/당일출고:-) 데일리 밑단컷팅 청스커트", "", "1,464개 구매중"));
        productList.add(new Product(R.raw.gif_product_1, photos, 10, 22800, "이너니티", "주문폭주/당일출고:-) 데일리 밑단컷팅 청스커트", "NEW" ,"1,464개 구매중"));
        productList.add(new Product(R.raw.gif_product_1, photos, 0, 22800, "이너니티", "주문폭주/당일출고:-) 데일리 밑단컷팅 청스커트", "HOT_DEAL", "1,464개 구매중"));
        productList.add(new Product(R.raw.gif_product_1, photos, 10, 22800, "이너니티", "주문폭주/당일출고:-) 데일리 밑단컷팅 청스커트", "", "1,464개 구매중"));
        productList.add(new Product(R.raw.gif_product_1, photos, 10, 22800, "이너니티", "주문폭주/당일출고:-) 데일리 밑단컷팅 청스커트", "NEW" ,"1,464개 구매중"));

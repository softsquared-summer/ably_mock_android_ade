...
import com.jinwoo.ably.src.fragment.Fragment1;
import com.jinwoo.ably.src.fragment.Fragment2;
import com.jinwoo.ably.src.fragment.Fragment3;
import com.jinwoo.ably.src.fragment.Fragment4;
...
public class MainActivity extends BaseActivity implements MainActivityView {
    ...
    private TextView mSeeMoreBenefits;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch(menuItem.getItemId()){
                    case R.id.top_today:
                        ...
                        mFragmentTransaction.replace(R.id.main_body_fragment, fragment1);
                        break;
                    case R.id.top_new:
                        Fragment2 fragment2 = new Fragment2();
                        mFragmentTransaction = getSupportFragmentManager().beginTransaction();
                        mFragmentTransaction.replace(R.id.main_body_fragment, fragment2);
                        break;
                    case R.id.top_best:
                        Fragment3 fragment3 = new Fragment3();
                        mFragmentTransaction = getSupportFragmentManager().beginTransaction();
                        mFragmentTransaction.replace(R.id.main_body_fragment, fragment3);
                        break;
                    case R.id.top_hot_deal:
                        Fragment4 fragment4 = new Fragment4();
                        mFragmentTransaction = getSupportFragmentManager().beginTransaction();
                        mFragmentTransaction.replace(R.id.main_body_fragment, fragment4);
                        break;
        ...
        Fragment1 fragment1 = new Fragment1();
        mFragmentTransaction = getSupportFragmentManager().beginTransaction();
        mFragmentTransaction.add(R.id.main_body_fragment, fragment1);
        mFragmentTransaction.commit();
